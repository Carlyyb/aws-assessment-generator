...
class I18nTextReplacer {
  ...
  initializeReplacements() {
    ...
    const textMappings = {
      ...
      '"Cancel"': 'getLangResource("common.actions.cancel")',
      '"Previous"': 'getLangResource("common.actions.previous")',
      '"Next"': 'getLangResource("common.actions.next")',
      '"Submit"': 'getLangResource("common.actions.submit")',
      '"Finish"': 'getLangResource("common.actions.finish")',
      '"Start"': 'getLangResource("common.start")',
      '"Review"': 'getLangResource("common.actions.review")',
      ...
      '"Publish"': 'getLangResource("common.actions.publish")',
      '"Published"': 'getLangResource("common.actions.published")',
