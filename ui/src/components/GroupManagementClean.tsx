...
const ColorDot = ({ color, size = 12 }: { color: string; size?: number }) => (
  <div
    style={{
      ...
      border: size > 20 ? '2px solid #ccc' : 'none'
    }}
  />
);
  ...
  return (
    <>
              ...
              },
              {
                ...
                cell: (item) => (
                  <SpaceBetween size="xs" direction="horizontal">
                    <Button variant="normal" onClick={() => openEditModal(item)}>
                      编辑
                    </Button>
                    <Button
                      variant="normal"
                    ...
                    <Button variant="normal" onClick={() => handleCopyGroup(item)}>
                      复制
                    </Button>
                  </SpaceBetween>
                ),
        ...
        <SpaceBetween size="l">
          ...
          <FormField label="标签颜色">
            <SpaceBetween size="s">
              <Box>
                <SpaceBetween size="xs" direction="horizontal" alignItems="center">
                  <ColorDot color={newGroupColor} size={24} />
              ...
              <Tiles
                ...
                items={presetColors.map(color => ({
                  value: color,
                  label: <ColorDot color={color} size={30} />
                }))}
                columns={5}
              />
              
              <Button variant="normal" onClick={() => setNewGroupColor(getRandomColor())}>
                随机颜色
              </Button>
            </SpaceBetween>
          </FormField>
        ...
        footer={
          <Box float="right">
            <SpaceBetween direction="horizontal" size="xs">
              ...
              <Button variant="primary" onClick={handleDeleteGroups}>
                确认删除
              </Button>
            </SpaceBetween>
          </Box>
      ...
      <Modal
        ...
        footer={
          <Box float="right">
            <Button variant="primary" onClick={() => setShowStudentsModal(false)}>
              关闭
            </Button>
          </Box>
        }
